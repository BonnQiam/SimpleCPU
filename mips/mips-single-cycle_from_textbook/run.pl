...
if (system ("make iss")) {
    ...
    if (!(-d "../mips-single-cycle_from_textbook/lib")) {
      system ("mkdir ../mips-single-cycle_from_textbook/lib");
    }
    print ("cp iss.so ../mips-single-cycle_from_textbook/lib/\n");
    system ("cp iss.so ../mips-single-cycle_from_textbook/lib/");
    ...
    chdir "../mips-single-cycle_from_textbook";
    if ($sim_mode eq 0) {
