...
my $sim_mode  = 0;
my $test_name = "pipeline_textbook";
my $regress_mode = 0;
my $help;
...
if (system ("make iss")) {
    ...
    if (!(-d "../mips-pipeline_from_textbook/lib")) {
      system ("mkdir ../mips-pipeline_from_textbook/lib");
    }
    print ("cp iss.so ../mips-pipeline_from_textbook/lib/\n");
    system ("cp iss.so ../mips-pipeline_from_textbook/lib/");
    ...
    chdir "../mips-pipeline_from_textbook";
    if ($sim_mode eq 0) {
